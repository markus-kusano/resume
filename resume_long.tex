...
\begin{itemize}
    ...
    \resitem{Virginia Tech STEP 2013 Presentation}
\end{itemize}
    ...
    \begin{itemize}
      ...
      \resitem{Summer 2013}
        \begin{itemize}
          ...
          partial order reduction algorithm for concurrent software testing.}
      ...
      \resitem{Spring 2013}
        \begin{itemize}
          \resitem{Implemented partial and higher order mutation operators on
            LLVM bitcode targeting POSIX and C++11 concurrency constructs.}
            %Used the LLVM library for both static analysis and
